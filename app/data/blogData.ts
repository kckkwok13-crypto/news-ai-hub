...
export const blogPosts: BlogPost[] = [
  ...
  // ===== 電玩遊戲專欄 =====
  {
    slug: "gaming/console-wars-2026",
    title: "🎮 2026 遊戲主機大戰：PS5、Switch 2、Xbox 邊個稱霸？",
    excerpt: "Nintendo Switch 2 正式登場！PS5 Pro、Xbox Series X2 蓄勢待發，2026年遊戲主機大戰誰能勝出？深度分析各大平台優劣勢！",
    date: "June 2026",
    image: "https://cdn.thewirecutter.com/wp-content/uploads/2023/09/PS5-vs-Xbox-controller-2.jpg",
    icon: "🎮",
    tags: ["PS5", "Switch 2", "Xbox", "主機大戰", "2026", "電玩"],
    accent: "from-blue-600 to-purple-600",
    category: "gaming"
  },
  {
    slug: "gaming/esports-tournament-2026",
    title: "🏆 2026 電競世界冠軍賽：獎金突破1億美元！",
    excerpt: "電競產業爆發式增長！英雄聯盟、S2、CS2 世界大賽獎金池創歷史新高，頂級電競選手年收入破千萬，電競時代正式來臨！",
    date: "June 2026",
    image: "https://cdn.oneesports.gg/cdn-cloudinary/image/upload/videos/esports-arena-1920x1080.jpg",
    icon: "🏆",
    tags: ["電競", "英雄聯盟", "CS2", "世界冠軍", "2026", "電玩"],
    accent: "from-yellow-500 to-orange-500",
    category: "gaming"
  },
  {
    slug: "gaming/vr-gaming-future",
    title: "🥽 VR 遊戲新時代：Meta Quest 4、Apple Vision Pro 2 領軍",
    excerpt: "虛擬實境遊戲突飛猛進！Meta Quest 4 支援4K解析度、Apple Vision Pro 2 加入遊戲陣容、元宇宙遊戲生態成形，2026年VR遊戲大爆發！",
    date: "June 2026",
    image: "https://cnet4.cds.patch.com/image/upload/f_auto,q_auto/v1/cnet/i/2024/10/07/c9eb7d8b-e4f9-4d82-ae21-c0a1e4f0d3cf/meta-quest-3s-02.jpg",
    icon: "🥽",
    tags: ["VR", "Meta Quest", "Apple Vision Pro", "元宇宙", "2026", "電玩"],
    accent: "from-cyan-500 to-blue-500",
    category: "gaming"
  },
  {
    slug: "gaming/mobile-gaming-trend",
    title: "📱 2026 手遊時代：手機遊戲取代 PC/Console？",
    excerpt: "手機遊戲市場規模突破1500億美元！《王者榮耀》、《原神》、《英雄聯盟手遊》領軍，2026年手遊繼續稱霸！分析手遊點解可以完勝其他平台！",
    date: "June 2026",
    image: "https://rog.asus.com/media/1750819347745.jpg",
    icon: "📱",
    tags: ["手遊", "原神", "王者榮耀", "2026", "電玩"],
    accent: "from-green-500 to-emerald-500",
    category: "gaming"
  },
  {
    slug: "gaming/retro-nostalgia",
    title: "🎮 復古遊戲熱潮：像素遊戲點解再次爆紅？",
    excerpt: "像素遊戲不再只是「懷舊」！2026年，復古風遊戲正式成為主流！從《Stray》到《Palworld》，像素風席捲全球！懷舊經濟學是真的！",
    date: "June 2026",
    image: "https://images.stockcake.com/public/1/f/b/1fb4d531-f86d-4ed9-bb10-786706277297_medium/pixel-art-evolution-stockcake.jpg",
    icon: "🎮",
