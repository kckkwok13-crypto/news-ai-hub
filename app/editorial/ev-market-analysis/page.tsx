...
export default function Page() {
  ...
  "translations": {
    "zh-TW": {
      ...
      "subtitle": "深入剖析EV MARKET ANALYSIS背後的底層技術邏輯與未來趨勢。",
      "sections": [
        {
          "heading": "🚩 現狀分析",
          "text": [
            "在當前的市場環境下，EV MARKET ANALYSIS正處於一個關鍵的轉折點。我們觀察到資金與人才正在大規模湧入。",
    ...
    "en": {
      "title": "EV MARKET ANALYSIS",
      "subtitle": "A strategic outlook on EV MARKET ANALYSIS.",
      "sections": [
        {
    ...
    "zh-CN": {
      "title": "EV MARKET ANALYSIS",
      "subtitle": "深度分析EV MARKET ANALYSIS的发展路径。",
      "sections": [
        {
          "heading": "🚩 行业洞察",
