  ...
  "translations": {
    "zh-TW": {
      ...
      "sections": [
        {
          "heading": "引言：變革的開端",
          "text": "EV MARKET ANALYSIS 的崛起，標誌著人類文明進入了一個智能與數字高度融合的新紀元。從矽谷到倫敦，從北京到新加坡，全球的創新者都在試圖解鎖這個領域蘊含的巨大能量。本篇分析將從全球宏觀趨勢出發，深度剖析其背後的技術原動力。"
        },
        {
          "heading": "市場動態分析",
    ...
    "zh-CN": {
      ...
      "sections": [
        {
          "heading": "引言：變革的開端",
          "text": "在当前全球经济的大背景下，EV MARKET ANALYSIS 正在引发一场前所未有的结构性变革。这不仅仅是单纯的技术更迭，更是生产力与生产关系的重组。我们深入调研了超过 50 家领先机构的内部数据，发现了一系列令人惊讶的底层规律。"
        },
        {
          "heading": "市場動態分析",
