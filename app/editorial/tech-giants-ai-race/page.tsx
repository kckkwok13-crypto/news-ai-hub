...
export default function Page() {
  ...
  "translations": {
    "zh-TW": {
      ...
      "subtitle": "深入剖析TECH GIANTS AI RACE背後的底層技術邏輯與未來趨勢。",
      "sections": [
        {
          "heading": "🚩 現狀分析",
          "text": [
            "在當前的市場環境下，TECH GIANTS AI RACE正處於一個關鍵的轉折點。我們觀察到資金與人才正在大規模湧入。",
    ...
    "en": {
      "title": "TECH GIANTS AI RACE",
      "subtitle": "A strategic outlook on TECH GIANTS AI RACE.",
      "sections": [
        {
    ...
    "zh-CN": {
      "title": "TECH GIANTS AI RACE",
      "subtitle": "深度分析TECH GIANTS AI RACE的发展路径。",
      "sections": [
        {
          "heading": "🚩 行业洞察",
