...
export default function Page() {
  ...
  "translations": {
    "zh-TW": {
      ...
      "subtitle": "深入剖析AI JOB REVOLUTION背後的底層技術邏輯與未來趨勢。",
      "sections": [
        {
          "heading": "🚩 現狀分析",
          "text": [
            "在當前的市場環境下，AI JOB REVOLUTION正處於一個關鍵的轉折點。我們觀察到資金與人才正在大規模湧入。",
    ...
    "en": {
      "title": "AI JOB REVOLUTION",
      "subtitle": "A strategic outlook on AI JOB REVOLUTION.",
      "sections": [
        {
    ...
    "zh-CN": {
      "title": "AI JOB REVOLUTION",
      "subtitle": "深度分析AI JOB REVOLUTION的发展路径。",
      "sections": [
        {
          "heading": "🚩 行业洞察",
