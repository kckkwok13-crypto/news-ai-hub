  ...
  "translations": {
    "zh-TW": {
      ...
      "sections": [
        {
          "heading": "引言：變革的開端",
          "text": "在當前全球經濟的大背景下，METAVERSE WORKPLACE 正在引發一場前所未有的結構性變革。這不僅僅是單純的技術更迭，更是生產力與生產關係的重組。我們深入調研了超過 50 家領先機構的內部數據，發現了一系列令人驚訝的底層規律。"
        },
        {
          "heading": "市場動態分析",
    ...
    "zh-CN": {
      ...
      "sections": [
        {
          "heading": "引言：變革的開端",
          "text": "在当前全球经济的大背景下，METAVERSE WORKPLACE 正在引发一场前所未有的结构性变革。这不仅仅是单纯的技术更迭，更是生产力与生产关系的重组。我们深入调研了超过 50 家领先机构的内部数据，发现了一系列令人惊讶的底层规律。"
        },
        {
          "heading": "市場動態分析",
