  ...
  "translations": {
    "zh-TW": {
      ...
      "sections": [
        {
          "heading": "引言：變革的開端",
          "text": "在這個日新月異的時代，WEB3 GAMING FUTURE 已經成為了我們無法忽視的核心議題。隨著技術的突破性發展，全球經濟結構與社會形態正經歷著一場前所未有的深刻變革。本篇深度分析專欄旨在通過多維度的數據挖掘與邏輯推導，為讀者呈現該領域最真實、最底層的運行規律。"
        },
        {
          "heading": "市場動態分析",
    ...
    "zh-CN": {
      ...
      "sections": [
        {
          "heading": "引言：變革的開端",
          "text": "在这个日新月异的时代，WEB3 GAMING FUTURE 已经成为了我们无法忽视的核心议题。随着技术的突破性发展，全球经济结构与社会形态正经历着一场前所未有的深刻变革。本篇深度分析专栏旨在通过多维度的数据挖掘与逻辑推导，为读者呈现该领域最真实、最底层的运行规律。"
        },
        {
          "heading": "市場動態分析",
