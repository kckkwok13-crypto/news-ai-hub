...
export default function SocialShare({ title, url }: SocialShareProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      <span className="text-slate-600 dark:text-slate-300 text-sm font-medium">分享：</span>
      ...
      <button
        ...
        className="p-2 rounded-full bg-slate-800 text-white hover:bg-slate-900 transition-colors"
      ...
      <button
        onClick={shareToLine}
        className="p-2 rounded-full bg-green-400 text-white hover:bg-green-500 transition-colors"
