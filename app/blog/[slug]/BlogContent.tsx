...
const blogData: Record<string, any> = {
  ...
  "meiji-shrine": {
    ...
    content: [
      ...
      { type: "highlight", title: "🕊️ 幸運限定：你有機會遇見「神前結婚式嗎？", text: "明治神宮是日本年輕人舉辦傳統婚禮的夢幻聖地。如果運氣好，在週末的上午前往，你很有機會在正殿前的廣場目睹一場傳統的「神前結婚式」—— 新娘身穿純白的「白無垢」，在神職人員與巫女的引領下緩步前行。現場氣氛極其莊重肅穆，是非常珍貴的文化體驗。" },
  ...
  "anne-frank-house": {
    ...
    content: [
      ...
      { type: "youtube", videoId: "ce89Q2thz8E", title: "安妮之家虛擬導覽 tour" },
      { type: "h2", text: "參觀感受" },
  ...
  "paris-france": {
    title: "浪漫之都：法國巴黎深度旅遊全攻略",
    date: "June 2026 · 作者：浪漫旅人",
    heroImage: "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=1200&q=80",
    heroCaption: "巴黎鐵塔夜景——這座「鐵娘子」見證了130年的浪漫與歷史",
    tocItems: [
      { id: "intro", title: "序言", emoji: "📖" },
      { id: "eiffel", title: "鐵塔", emoji: "🗼" },
      { id: "louvre", title: "羅浮宮", emoji: "🏛️" },
      { id: "notredame", title: "聖母院", emoji: "⛪" },
      { id: "tips", title: "實用提示", emoji: "💡" },
    ],
    activeColor: "blue",
    content: [
      { type: "p", id: "intro", text: "如果要選一個城市能代表<strong>浪漫</strong>、<strong>藝術</strong>與<strong>時尚</strong>的完美結合，那一定是<strong>法國巴黎（Paris）</strong>！這座被稱為「光之城」（La Ville-Lumière）的都市，不僅是全球最受欢迎的旅遊目的地之一，更是無數藝術家、設計師與夢想家的靈感聖地。" },
      { type: "youtube", videoId: "DRs9sZsbqk8", title: "巴黎春季漫步之旅 4K HDR" },
      { type: "p", text: "從宏偉的艾菲爾鐵塔到優雅的香榭麗舍大道，從神秘的羅浮宮到莊嚴的聖母院，每一處都散發著獨特的法式魅力。今天這篇Blog，帶你深度走訪巴黎的必遊景點與隱藏美食！" },
      { type: "h2", text: "永恆地標：艾菲爾鐵塔" },
      { type: "h3", text: "1. 鐵塔的浪漫秘密" },
      { type: "p", id: "eiffel", text: "說到巴黎，第一個想到的一定是<strong>艾菲爾鐵塔（La Tour Eiffel）</strong>。這座建於1889年、耗時兩年多完工的鐵塔，當初曾被巴黎人嘲笑為「醜陋的怪物」，如今卻成為了全球最辨識度最高的建築之一。" },
      { type: "highlight", title: "🗼 艾菲爾鐵塔小知識", text: "• <strong>高度：</strong>324米（包括天線）<br/>• <strong>建造時間：</strong>1887-1889年，僅用了2年2個月<br/>• <strong>造價：</strong>約780萬金法郎<br/>• <strong>設計師：</strong>古斯塔夫·艾菲爾（Gustave Eiffel）<br/>• <strong>樓梯級數：</strong>1665級台階（到二樓）" },
      { type: "image", src: "https://images.unsplash.com/photo-1511739001486-6bfe10ce785f?w=1200&q=80", alt: "艾菲爾鐵塔", caption: "夜幕下的艾菲爾鐵塔，每整點閃爍5分鐘的璀璨燈光秀" },
      { type: "h2", text: "藝術殿堂：羅浮宮" },
      { type: "h3", text: "2. 羅浮宮：世界最大的博物館" },
      { type: "p", id: "louvre", text: "羅浮宮（Louvre）曾是法國皇宮，如今是<strong>全球最大的博物館</strong>，收藏了超過38萬件藝術品。如果要仔細看完所有展品，據說需要整整三個月的時間！" },
      { type: "highlight", title: "🏛️ 羅浮宮必看三寶", text: "1. <strong>蒙娜麗莎（Mona Lisa）</strong> —— 達文西的傳世之作，永恆的微笑<br/>2. <strong>米羅的維納斯（Venus de Milo）</strong> —— 古希臘最美雕塑之一<br/>3. <strong>勝利女神（Nike of Samothrace）</strong> —— 栩栩如生的飛翔姿態" },
      { type: "youtube", videoId: "JAOOCsgi6Yc", title: "巴黎秋季漫步之旅 4K HDR" },
      { type: "h2", text: "哥德式建築：巴黎聖母院" },
      { type: "h3", text: "3. 聖母院浴火重生" },
      { type: "p", id: "notredame", text: "<strong>巴黎聖母院大教堂（Cathédrale Notre-Dame de Paris）</strong>建於1163年至1345年，是法國哥德式建築的代表作。2019年的一場大火，讓這座850年歷史的教堂遭受重創。目前修復工程已基本完成，預計將重新向公眾開放。" },
      { type: "tips", title: "巴黎旅遊實用小貼士 (Travel Tips)", items: ["<strong>博物館通行證：</strong>強烈建議購買「巴黎博物館通行證」（Paris Museum Pass），可免費進入50多個博物館和景點，省錢又省排隊時間。", "<strong>交通方式：</strong>巴黎地鐵非常方便，購買10次票（Carnet）比單程票更劃算。建議辦一張Navigo交通卡。", "<strong>最佳拍攝點：</strong> Trocadéro 花園是拍攝艾菲爾鐵塔的最佳位置，建議黃昏時分前往，既能拍日景又能等夜景。", "<strong>美食推薦：</strong>品嚐法式可頌、馬卡龍、蝸牛和傳統法式洋蔥湯。推薦去當地人常去的餐廳，不要只去遊客區。", "<strong>語言提示：</strong>學會幾句基本法語（如Bonjour、Merci、Au revoir）會讓法國人對你更有好感！"] },
    ],
    infoCards: [
      { label: "📍 地址", value: "Paris, France" },
      { label: "🕐 開放時間", value: "各景點不同，建議提前查詢" },
      { label: "💰 費用", value: "景點門票 €15-26 / 博物館通行證 €48-83" },
      { label: "⭐ 評分", value: "4.8/5.0（1,234,567 評論）" },
      { label: "🚇 交通", value: "巴黎地鐵覆蓋全市" },
      { label: "⏱️ 建議遊覽", value: "3-5天" },
    ],
  },
  "rome-colosseum": {
    title: "永恆之城：意大利羅馬競技場與古蹟深度之旅",
    date: "May 2026 · 作者：歷史探索者",
    heroImage: "https://images.unsplash.com/photo-1552832230-c0197dd311b5?w=1200&q=80",
    heroCaption: "羅馬競技場——這座橢圓形的巨石建築，承載著2000年的輝煌與衰落",
    tocItems: [
      { id: "intro", title: "序言", emoji: "📖" },
      { id: "colosseum", title: "競技場", emoji: "🏟️" },
      { id: "forum", title: "古羅馬廣場", emoji: "🏛️" },
      { id: "vatican", title: "梵蒂岡", emoji: "⛪" },
      { id: "tips", title: "實用提示", emoji: "💡" },
    ],
    activeColor: "red",
    content: [
      { type: "p", id: "intro", text: "<strong>羅馬（Roma）</strong>——這座被稱為「永恆之城」的都市，是世界上最古老的城市之一，也是古羅馬帝國的心臟。走在羅馬街頭，彷彿穿越了2700年的時空：古競技場的斑駁石牆、梵蒂岡的宏偉穹頂、許願池的浪漫傳說……每一處都是歷史與藝術的完美交融。" },
      { type: "youtube", videoId: "da-XDINTtQc", title: "羅馬競技場地下導覽" },
      { type: "p", text: "今天這篇Blog，就帶大家走進這座承載著古羅馬輝煌的永恆之城，探索那些不可錯過的歷史瑰寶！" },
      { type: "h2", text: "鬥獸之爭：羅馬競技場" },
      { type: "h3", text: "1. 全球最大的圓形劇場" },
      { type: "p", id: "colosseum", text: "<strong>羅馬競技場（Colosseo）</strong>建於公元72年至82年間，是古羅馬帝國時期最宏偉的建築之一。這座橢圓形的巨大劇場，可容納超過5萬名觀眾，曾是角鬥士比賽、野獸表演和公眾展示的場所。" },
      { type: "highlight", title: "🏟️ 羅馬競技場小知識", text: "• <strong>建造時間：</strong>公元72-82年（維斯帕先皇帝下令建造）<br/>• <strong>尺寸：</strong>長軸189米、短軸156米、高度48米<br/>• <strong>容量：</strong>約50,000-80,000名觀眾<br/>• <strong>特色：</strong>擁有一套複雜的地下通道系統，角鬥士和野獸可通過升降機直達表演場地" },
      { type: "youtube", videoId: "CVyuqIoB7qg", title: "羅馬競技場完整導覽" },
      { type: "h2", text: "帝國心臟：古羅馬廣場" },
      { type: "h3", text: "2. 羅馬的心臟地帶" },
      { type: "p", id: "forum", text: "<strong>古羅馬廣場（Roman Forum）</strong>曾是古羅馬的政治、宗教和商業中心。這片廢墟中，你仍然可以看到曾經輝煌的元老院、凱撒神廟和提圖斯凱旋門。夕陽西下時漫步其間，歷史的厚重感會讓你久久難以忘懷。" },
      { type: "h2", text: "信仰中心：梵蒂岡城國" },
      { type: "h3", text: "3. 世界最小的國家" },
      { type: "p", id: "vatican", text: "<strong>梵蒂岡城國（Città del Vaticano）</strong>是世界上最小的國家，卻擁有世界上最大的教堂——<strong>聖伯多祿大教堂（Basilica di San Pietro）</strong>。教堂內的米開朗基羅穹頂、貝爾尼尼設計的青銅華蓋，以及無價的藝術收藏，讓人嘆為觀止。" },
      { type: "tips", title: "羅馬旅遊實用小貼士 (Travel Tips)", items: ["<strong>門票預訂：</strong>羅馬競技場門票非常搶手，強烈建議提前在官方網站預訂。建議購買「羅馬通行證」（Roma Pass）包含交通費和多個景點門票。", "<strong>穿著建議：</strong>進入教堂需要穿著得體，肩膀和膝蓋不能露出来。建議帶備一件薄外套或披肩。", "<strong>防盜提示：</strong>羅馬是小偷的天堂，特別是在熱門景點和地鐵上。把手機和錢包放在前面口袋或防盜腰包。", "<strong>美食推薦：</strong>品嚐正宗的義大利 Carbonara 意粉、羅馬式薄脆披薩、提拉米蘇和濃縮咖啡。避開景點周圍的旅遊陷阱餐廳。", "<strong>最佳時間：</strong>4-6月或9-10月是遊覽羅馬的最佳時節，天氣舒適且遊客相對較少。"] },
    ],
    infoCards: [
      { label: "📍 地址", value: "Rome, Italy" },
      { label: "🕐 開放時間", value: "各景點不同，建議提前查詢" },
      { label: "💰 費用", value: "競技場 €16-22 / 羅馬通行證 €34-52" },
      { label: "⭐ 評分", value: "4.9/5.0（892,456 評論）" },
      { label: "🚇 交通", value: "羅馬地鐵A/B線覆蓋主要景點" },
      { label: "⏱️ 建議遊覽", value: "3-4天" },
    ],
  },
  "london-uk": {
    title: "皇室與現代的完美融合：英國倫敦深度旅遊攻略",
    date: "April 2026 · 作者：英倫探索者",
    heroImage: "https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=1200&q=80",
    heroCaption: "倫敦天際線——大笨鐘與國會大廈的經典風景",
    tocItems: [
      { id: "intro", title: "序言", emoji: "📖" },
      { id: "westminster", title: "國會大廈", emoji: "🏛️" },
      { id: "tower", title: "倫敦塔", emoji: "🗼" },
      { id: "museums", title: "博物館", emoji: "🎨" },
      { id: "tips", title: "實用提示", emoji: "💡" },
    ],
    activeColor: "amber",
    content: [
      { type: "p", id: "intro", text: "<strong>倫敦（London）</strong>——這座融合了千年皇室傳統與前衛當代藝術的都市，是世界上最令人著迷的城市之一。從宏偉的國會大廈到神秘的倫敦塔，從世界頂級的博物館到充滿街頭藝術的肖爾迪奇，每一個角落都訴說著不同的故事。" },
      { type: "youtube", videoId: "W4P_YhU22_Y", title: "倫敦城市導覽 4K" },
      { type: "p", text: "說到英國，你會想到什麼？是皇室的莊嚴禮儀、搖滾樂的狂野精神、還是下午茶的優雅傳統？今天這篇Blog，就帶你深度走進這座霧都的每一個精彩瞬間！" },
      { type: "h2", text: "皇室象徵：國會大廈與大笨鐘" },
      { type: "h3", text: "1. 西敏宮的輝煌" },
      { type: "p", id: "westminster", text: "<strong>國會大廈（Palace of Westminster）</strong>是英國議會的所在地，也是倫敦最標誌性的建築之一。與其相鄰的<strong>大笨鐘（Big Ben）</strong>其實是指塔內的大鐘，而非整座塔樓（正確名稱是伊莉莎白塔）。" },
      { type: "highlight", title: "🏛️ 國會大廈小知識", text: "• <strong>建造時間：</strong>1840-1860年重建<br/>• <strong>房間數量：</strong>約1,100間<br/>• <strong>鐘樓高度：</strong>96米<br/>• <strong>大笨鐘重量：</strong>約13.5噸<br/>• <strong>建造費用：</strong>當年耗資超過200萬英鎊" },
      { type: "youtube", videoId: "62F0sEM_f9c", title: "倫敦漫步之旅 4K" },
      { type: "h2", text: "千年堡壘：倫敦塔" },
      { type: "h3", text: "2. 皇室的監獄與珠寶" },
      { type: "p", id: "tower", text: "<strong>倫敦塔（Tower of London）</strong>有著近千年的歷史，曾是皇宮、監獄、武器庫和珠寶庫。白塔（White Tower）是倫敦最古老的部分，裡面收藏著皇室珠寶和皇冠。最特別的是，每位守衛（Beefeater）都有著獨特的故事！" },
      { type: "h2", text: "文化寶庫：世界級博物館" },
      { type: "h3", text: "3. 免費的藝術饗宴" },
      { type: "p", id: "museums", text: "倫敦擁有世界上最頂級的博物館，而且<strong>全部免費入場</strong>！<strong>大英博物館</strong>收藏了來自全球的珍貴文物；<strong>國家美術館</strong>珍藏著梵谷、莫內、達文西的真跡；<strong>自然歷史博物館</strong>則是恐龍迷的天堂。" },
      { type: "tips", title: "倫敦旅遊實用小貼士 (Travel Tips)", items: ["<strong>牡蠣卡（Oyster Card）：</strong>必備交通卡！可在地鐵站購買並充值，在倫敦市內乘坐地鐵、巴士和有軌電車都可用，比單程票便宜很多。", "<strong>博物館巡禮：</strong>大英博物館、國家美術館、自然歷史博物館、科學博物館、泰特現代美術館——全部免費！建議預留至少2天時間參觀。", "<strong>下午茶體驗：</strong>倫敦的傳統下午茶不可錯過。推薦去 Fortnum & Mason 或 The Ritz，記得提前預訂！", "<strong>門票優惠：</strong>購買「倫敦通行證」（London Pass）可免費進入多個景點並節省排隊時間。", "<strong>天氣準備：</strong>倫敦天氣變化無常，隨身帶一把摺疊傘是必須的！建議洋蔥式穿法，方便增減衣物。"] },
    ],
    infoCards: [
      { label: "📍 地址", value: "London, United Kingdom" },
      { label: "🕐 開放時間", value: "各景點不同，建議提前查詢" },
      { label: "💰 費用", value: "景點門票 £20-40 / 倫敦通行證 £70-150" },
      { label: "⭐ 評分", value: "4.7/5.0（1,567,890 評論）" },
      { label: "🚇 交通", value: "倫敦地鐵覆蓋全市（12條線）" },
      { label: "⏱️ 建議遊覽", value: "4-6天" },
    ],
  },
};
