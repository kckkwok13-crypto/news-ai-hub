      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="rounded-2xl overflow-hidden mb-12 border border-cyan-500/30 bg-gradient-to-r from-cyan-900/20 to-blue-900/20">
          <div className="flex items-center gap-3 px-5 py-3 border-b border-cyan-500/20">
            ...
            <span className="text-cyan-400 text-sm font-bold">🎬 相關影片推薦</span>
          </div>
          <div className="relative aspect-video">
            ...
            <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
              <div className="text-center">
                <div className="w-20 h-20 rounded-full bg-cyan-500 flex items-center justify-center mx-auto mb-4 shadow-lg">
                  <svg className="w-10 h-10 text-black" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M8 5v14l11-7z"/>
                  </svg>
                </div>
                <p className="text-white text-sm font-medium">2026 遊戲主機大戰</p>
                <p className="text-gray-300 text-xs mt-1">PS5 vs Xbox vs Nintendo</p>
              </div>
            </div>
          </div>
        </div>
