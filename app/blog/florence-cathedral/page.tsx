    ...
    <div className="min-h-screen bg-[#faf8f5] text-[#2b2d42]">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="relative mb-8 rounded-2xl overflow-hidden shadow-2xl shadow-[#1b4d3e]/20">
          <img
            src="https://images.unsplash.com/photo-1543429258-49a7a091da1d?w=1200&q=80"
            alt="佛羅倫斯聖母百花大教堂全景"
            className="w-full h-80 object-cover"
            onError={(e) => {
              e.currentTarget.src = "https://images.unsplash.com/photo-1775343970007-d70d54e86526?w=1200&q=80";
            }}
          />
        </div>
